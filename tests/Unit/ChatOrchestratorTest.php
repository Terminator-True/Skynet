...
it('includes every registered tool definition in each request', function () {
    ...
    Http::assertSent(function ($request) {
        ...
        return $names === ['get_current_time', 'calculate_sum', 'get_weather_mock', 'listar_eventos_calendario', 'buscar_correos', 'leer_correo', 'extraer_tracking_amazon', 'buscar_web', 'recordar_preferencia', 'buscar_notas', 'guardar_nota'];
    });
});
